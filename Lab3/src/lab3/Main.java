...
public class Main extends Application {
	...
	private Button waterButton, smellButton, plantButton, waitButton;
	...
	private void addButtons() {
		...
		plantButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				Human.plant(flowers, plantComboBox.getValue());
		...
		waitButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				theLabel.setText("Ожидание.");
			}
		});
		gridpane.add(waitButton, 2, 2);
	}
	private void addComboBoxes() {
		plantComboBox = new ComboBox<String>( FXCollections.observableArrayList("Rose","Viola","Gladiolus"));
